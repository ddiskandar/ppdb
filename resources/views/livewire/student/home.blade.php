                ...
                <div class="grid gap-8 sm:grid-cols-12">
                    <div class="sm:col-span-4 lg:col-span-3">
                        <div class="overflow-hidden bg-white shadow-2xl rounded-2xl">
                            <img alt="photo" class="object-cover object-center w-full h-96" @if( $user_photo=Auth::user()->photo )
                    ...
                    <div class="sm:col-span-12 lg:col-span-4 ">
                        <div>
                            ...
                            <div class="py-6">
                                <x-action-card completed="{!! ( Auth::user()->student->is_alur_completed() ) ? 'true' : 'false' !!}" title="Cetak Kartu" 
                                    action="{!! Auth::user()->student->is_alur_completed() ? route('student.pdf', Auth::user()->student->id) : '#' !!}" 
                ...
                <div class="md:grid md:grid-cols-3 md:gap-6">
                    ...
                    <div class="px-4 mt-5 sm:px-0 md:mt-0 md:col-span-2">
                        <div class="grid gap-6 lg:grid-cols-2">
                            ...
                            <x-action-card completed="{!! ( Auth::user()->student->ppdb ) ? 'true' : 'false' !!}" title="Gelombang" description="Pilih Jalur Pendaftaran">
                            ...
                            <x-action-card completed="{!! ( isset(Auth::user()->student->ppdb->pilihan_satu) ) ? 'true' : 'false' !!}" action="jurusan" title="Pilih Jurusan" description="Tentukan jurusan kalian">
                            ...
                            <x-action-card completed="{!! ( Auth::user()->student->ppdb->join_wa ) ? 'true' : 'false' !!}" action="group" title="Gabung Grup WA" description="Untuk info PPDB lainnya">
                            ...
                            <x-action-card completed="{!! ( Auth::user()->student->is_data_completed() ) ? 'true' : 'false' !!}" action="biodata" title="Biodata" description="Isi data profil diri">
                            ...
                            <x-action-card completed="{!! ( Auth::user()->student->is_document_completed() ) ? 'true' : 'false' !!}" action="berkas" title="Unggah Berkas" description="Ijazah, Akta, Kartu keluarga">
                            ...
                            <x-action-card completed="{{ ( Auth::user()->student->is_payment_completed() ) ? 'true' : 'false' }}" action="pembayaran" title="Bayar Pendaftaran" description="Membayar biaya pendaftaran">
