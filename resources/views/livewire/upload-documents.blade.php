            ...
            <form action="#" method="POST">
                ...
                <div class="px-4 py-5 space-y-6 bg-white sm:p-6">
                    ...
                    <div>
                        ...
                        <div class="mt-2 w">
                            <div class="inline-block w-48 h-32 overflow-hidden border-2 border-gray-200 border-dashed rounded-md">

                                <img class="bg-cover" src="/storage/{{ $student->documents->where('type', 'photo')->first()->path }}">
                        ...
                        <div class="overflow-hidden shadow sm:rounded-md">
                            <div class="px-4 py-5 bg-white sm:p-6">
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <input wire:model.lazy="name" type="text" name="name" id="name" autocomplete="given-name" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                ...
                                <div class="col-span-6 sm:col-span-4">
                                    ...
                                    <input wire:model.lazy="email" type="text" name="email" id="email" autocomplete="email" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                ...
                                <div class="col-span-6">
                                    ...
                                    <div class="mt-1">
                                        <textarea wire:model.lazy="message" id="about" name="message" rows="3" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"></textarea>
