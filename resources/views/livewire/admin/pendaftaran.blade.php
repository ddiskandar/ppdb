                            ...
                            <td class="px-3 py-4 whitespace-nowrap">
                                <div>
                                    <span class="inline-flex px-2 text-xs font-semibold leading-5 text-green-800 rounded-full
                                        {{ ( isset($student->document->kartu_keluarga) ) ? 'bg-green-100' : 'bg-gray-100' }}
                                    ">
                                        KK
                                    </span>
                                    <span class="inline-flex px-2 text-xs font-semibold leading-5 text-green-800 rounded-full
                                    {{ ( isset($student->document->akta) ) ? 'bg-green-100' : 'bg-gray-100' }}
                                    ">
                                    Akta
                                    </span>
                                    <span class="inline-flex px-2 text-xs font-semibold leading-5 text-green-800 rounded-full 
                                    {{ ( isset($student->document->skl) ) ? 'bg-green-100' : 'bg-gray-100' }}
                                    ">
                                    SKL
                                    </span>
                                    <span class="inline-flex px-2 text-xs font-semibold leading-5 text-green-800 rounded-full
                                    {{ ( isset($student->document->ijazah) ) ? 'bg-green-100' : 'bg-gray-100' }}">
                                    Ijazah
                                    </span>
                                </div>
                                <div>
                                    <span class="inline-flex px-2 text-xs font-semibold leading-5 text-green-800 rounded-full
                                        {{ ( isset($student->document->kip) ) ? 'bg-green-100' : 'bg-gray-100' }}
                                    ">
                                    KIP
                                    </span>
                                    <span class="inline-flex px-2 text-xs font-semibold leading-5 text-green-800 rounded-full
                                        {{ ( isset($student->document->pkh) ) ? 'bg-green-100' : 'bg-gray-100' }}
                                    ">
                                    PKH
                                    </span>
                                    <span class="inline-flex px-2 text-xs font-semibold leading-5 text-green-800 rounded-full
                                        {{ ( isset($student->document->kks) ) ? 'bg-green-100' : 'bg-gray-100' }}
                                    ">
                                    KKS
                                    </span>
                                    <span class="inline-flex px-2 text-xs font-semibold leading-5 text-green-800 rounded-full
                                        {{ ( isset($student->document->kis) ) ? 'bg-green-100' : 'bg-gray-100' }}
                                    ">
                                    KIS
                                    </span>
                                </div>
                            ...
                            <td class="px-3 py-4 whitespace-nowrap">
                                <div class="flex items-center text-sm text-gray-900">
                                    ...
                                    @else
                                        ...
                                        <svg class="ml-2"  xmlns="http://www.w3.org/2000/svg" width="18" height="18"><path data-name="Path 130" d="M7.222 10.778L9 9m0 0l1.778-1.778M9 9L7.222 7.222M9 9l1.778 1.778M17 9a8 8 0 11-8-8 8 8 0 018 8z" fill="none" stroke="#be6060" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/></svg>
                                    @endif
                                </div>
                                <div class="text-sm text-gray-500">
                                    Rp. {{ $student->bayar() }} ,-
